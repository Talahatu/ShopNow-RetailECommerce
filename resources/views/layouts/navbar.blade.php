                ...
                <div class="order-lg-last col-lg-5 col-sm-8 col-8">
                    <div class="d-flex float-end">
                        ...
                        <a class="dropdown-toggle py-1 px-3 nav-link d-flex align-items-center hidden-arrow"
                            ...
                            aria-expanded="false">
                            <img src="{{ Auth::check() && file_exists(public_path('profileimages/' . Auth::user()->profilePicture)) && Auth::user()->profilePicture != null ? asset('profileimages/' . Auth::user()->profilePicture) : 'https://mdbcdn.b-cdn.net/img/new/avatars/2.webp' }}"
